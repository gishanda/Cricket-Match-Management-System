...
$va_runsByRuns = "SELECT W.wickets_id AS 'wicketsID', P.player_name AS 'pName', M.matches_id AS 'mId', W.wickets_matchWickets AS 'wickets'
...
ORDER BY W.wickets_matchWickets DESC";
		...
		<div id="main">	
			<div class="wrapper clearfix">
	        	...
	        	<div id="page-content" class="clearfix">
                    ...
                    <h2 class="page-heading"><span>WICKETS BY MATCH REPORT</span></h2>
						<div align="center">					
                        ...
                        <br/>
							...
							<table width="700" border="1" cellspacing="3" style="color:#000">
                              ...
                              <tr>
                                ...
                                <td bgcolor="#FFFFFF"><div><?php echo $rowrunsByRuns["wickets"]; ?></div></td>
                              </tr>
                                <?php 	
									}
								}
