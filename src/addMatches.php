		...
		<div id="main">	
			<div class="wrapper clearfix">
	        	...
	        	<div id="page-content" class="clearfix">
                    ...
                    <h2 class="page-heading"><span>ADD MATCHES</span></h2>
						<div align="center">					
                            <form action="addMatches_Action.php" method="POST" enctype="multipart/form-data" name="addMatches" id="addMatches">
                                <table width="500" border="0" cellspacing="2" cellpadding="3">
                                  ...
                                  <tr>
                                    ...
                                    <td><span id="sprytextfield2">
                                      <label>
                                        <input type="text" name="txt_venue" id="txt_venue" />
                                      </label>
                                  ...
                                  <tr>
                                    ...
                                    <label>
                                      <input name="txt_date" type="text" id="txt_date" value="" />
                                    </label>
                                    <span class="textfieldRequiredMsg">Date  is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                                  </tr>
                                  <tr>
									<td>
