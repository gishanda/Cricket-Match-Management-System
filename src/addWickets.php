		...
		<div id="main">	
			<div class="wrapper clearfix">
	        	...
	        	<div id="page-content" class="clearfix">
                    ...
                    <h2 class="page-heading"><span>ADD WICKETS</span></h2>
						<div align="center">					
                          <form action="addWickets_Action.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                <table width="500" border="0" cellspacing="2" cellpadding="3">
                                  ...
                                  <tr>
                                    ...
                                    <td><span id="sprytextfield1">
                                      <label>
                                        <input type="text" name="txt_wickets" id="txt_wickets"  />
                                      </label>
